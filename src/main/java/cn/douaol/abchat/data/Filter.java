...
public class Filter {
    ...
    public static List<String> singleFilterWordList = new ArrayList<>();
    ...
    public static void loadFilter() throws IOException {
        ...
        if(Config.language.toLowerCase(Locale.ROOT).contains("cn") || Config.language.toLowerCase(Locale.ROOT).contains("tw")) {
        ...
        List<String> singleFilter = new ArrayList<>();
        singleFilter.add("L");
        if(Config.language.toLowerCase(Locale.ROOT).contains("cn") || Config.language.toLowerCase(Locale.ROOT).contains("tw")) {
            singleFilter.add("fw");
            singleFilter.add("sb");
        }
        filter.addDefault("single-filter", singleFilter);
